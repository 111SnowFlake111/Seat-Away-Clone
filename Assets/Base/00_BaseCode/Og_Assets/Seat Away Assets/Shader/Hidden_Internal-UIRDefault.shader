...
void main()
{
    u_xlat16_0.xyz = in_COLOR0.xyz * vec3(0.265884995, 0.265884995, 0.265884995) + vec3(0.736584008, 0.736584008, 0.736584008);
    u_xlat16_0.xyz = in_COLOR0.xyz * u_xlat16_0.xyz + vec3(-0.00980184041, -0.00980184041, -0.00980184041);
    u_xlat16_0.xyz = in_COLOR0.xyz * u_xlat16_0.xyz + vec3(0.00319697009, 0.00319697009, 0.00319697009);
    u_xlat16_1.xyz = in_COLOR0.xyz * vec3(0.0849710032, 0.0849710032, 0.0849710032) + vec3(-0.000163029006, -0.000163029006, -0.000163029006);
    u_xlatb2.xyz = lessThan(in_COLOR0.xyzx, vec4(0.0725490004, 0.0725490004, 0.0725490004, 0.0)).xyz;
    vs_COLOR0.x = (u_xlatb2.x) ? u_xlat16_1.x : u_xlat16_0.x;
    vs_COLOR0.y = (u_xlatb2.y) ? u_xlat16_1.y : u_xlat16_0.y;
    vs_COLOR0.z = (u_xlatb2.z) ? u_xlat16_1.z : u_xlat16_0.z;
    u_xlat0 = in_TEXCOORD2.xwzy * vec4(255.0, 255.0, 255.0, 255.0);
    u_xlat0 = roundEven(u_xlat0);
    u_xlat2.xyz = u_xlat0.xzw * vec3(32.0, 32.0, 32.0);
    u_xlatb2.xyz = greaterThanEqual(u_xlat2.xyzx, (-u_xlat2.xyzx)).xyz;
    u_xlat1.x = (u_xlatb2.x) ? float(32.0) : float(-32.0);
    u_xlat1.y = (u_xlatb2.x) ? float(0.03125) : float(-0.03125);
    u_xlat1.z = (u_xlatb2.y) ? float(32.0) : float(-32.0);
    u_xlat1.w = (u_xlatb2.y) ? float(0.03125) : float(-0.03125);
    u_xlat2.xy = (u_xlatb2.z) ? vec2(32.0, 0.03125) : vec2(-32.0, -0.03125);
    u_xlat18.xy = u_xlat0.xz * u_xlat1.yw;
    u_xlat18.xy = fract(u_xlat18.xy);
    u_xlat3.xy = (-u_xlat1.xz) * u_xlat18.xy + u_xlat0.xz;
    u_xlat18.xy = u_xlat1.xz * u_xlat18.xy;
    u_xlat3.xy = u_xlat3.xy * vec2(0.09375, 0.03125);
    u_xlat19.y = in_TEXCOORD3.y * 2040.0 + u_xlat3.y;
    u_xlat3.y = in_TEXCOORD1.y * 2040.0 + u_xlat3.x;
    u_xlat19.x = in_TEXCOORD3.x * 8160.0 + u_xlat18.y;
    u_xlat3.x = in_TEXCOORD1.x * 8160.0 + u_xlat18.x;
    u_xlat18.xy = u_xlat19.xy + vec2(0.5, 0.5);
    u_xlat1.zw = u_xlat18.xy * _ShaderInfoTex_TexelSize.xy;
    u_xlat18.x = textureLod(_ShaderInfoTex, u_xlat1.zw, 0.0).w;
    u_xlat18.x = u_xlat18.x * in_COLOR0.w;
    vs_COLOR0.w = u_xlat18.x;
    u_xlat4 = u_xlat3.xyxy + vec4(0.5, 0.5, 0.5, 1.5);
    u_xlat18.xy = u_xlat3.xy + vec2(0.5, 2.5);
    u_xlat18.xy = u_xlat18.xy * _ShaderInfoTex_TexelSize.xy;
    u_xlat3 = textureLod(_ShaderInfoTex, u_xlat18.xy, 0.0);
    u_xlat18.x = dot(u_xlat3, in_POSITION0);
    u_xlat3 = u_xlat4 * _ShaderInfoTex_TexelSize.xyxy;
    u_xlat4 = textureLod(_ShaderInfoTex, u_xlat3.xy, 0.0);
    u_xlat3 = textureLod(_ShaderInfoTex, u_xlat3.zw, 0.0);
    u_xlat21.x = dot(u_xlat4.xy, in_TEXCOORD0.xy);
    u_xlat20.x = dot(u_xlat4, in_POSITION0);
    u_xlat21.y = dot(u_xlat3.xy, in_TEXCOORD0.xy);
    u_xlat20.y = dot(u_xlat3, in_POSITION0);
    u_xlat3.xy = u_xlat21.xy * _1PixelClipInvView.zw;
    u_xlat19.xy = max(abs(u_xlat3.xy), vec2(1.0, 1.0));
    u_xlat3.xy = abs(u_xlat3.xy) + vec2(9.99999997e-07, 9.99999997e-07);
    u_xlat4.xy = u_xlat19.xy + vec2(0.0199999996, 0.0199999996);
    u_xlat4.xy = roundEven(u_xlat4.xy);
    u_xlat19.xy = max(u_xlat19.xy, u_xlat4.xy);
    u_xlatb6 = equal(u_xlat0.yyyy, vec4(9.0, 8.0, 7.0, 6.0));
    {
        vec2 hlslcc_movcTemp = u_xlat19;
        hlslcc_movcTemp.x = (u_xlatb6.w) ? u_xlat19.x : u_xlat4.x;
        hlslcc_movcTemp.y = (u_xlatb6.z) ? u_xlat19.y : u_xlat4.y;
        u_xlat19 = hlslcc_movcTemp;
    }
    u_xlat3.xy = u_xlat19.xy / u_xlat3.xy;
    u_xlat3.xy = max(u_xlat3.xy, vec2(0.00999999978, 0.00999999978));
    u_xlat3.xy = min(u_xlat3.xy, vec2(100.0, 100.0));
    u_xlat3.xy = u_xlat3.xy + vec2(-1.0, -1.0);
    u_xlat3.xy = u_xlat21.xy * u_xlat3.xy;
    u_xlatb5 = equal(u_xlat0.yyyy, vec4(5.0, 4.0, 3.0, 2.0));
    u_xlatb26 = u_xlatb6.w || u_xlatb5.x;
    u_xlatb26 = u_xlatb6.z || u_xlatb26;
    u_xlat6.x = u_xlatb6.y ? float(1.0) : 0.0;
    u_xlat6.y = u_xlatb6.x ? float(1.0) : 0.0;
;
    u_xlat3.xy = bool(u_xlatb26) ? u_xlat3.xy : vec2(0.0, 0.0);
    u_xlat3.xy = u_xlat3.xy + u_xlat20.xy;
    vs_TEXCOORD0.zw = u_xlat3.xy;
    u_xlat19.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat4.xy = u_xlat19.xy * _MainTex_TexelSize.xy;
    u_xlat5.x = u_xlatb5.y ? float(1.0) : 0.0;
    u_xlat5.y = u_xlatb5.z ? float(1.0) : 0.0;
    u_xlat5.z = u_xlatb5.w ? float(1.0) : 0.0;
;
    u_xlat26 = (u_xlatb5.w) ? -1.0 : -0.0;
    u_xlat7.y = u_xlat26 + u_xlat5.y;
    u_xlat26 = u_xlat5.z + u_xlat5.y;
#ifdef UNITY_ADRENO_ES3
    u_xlatb20 = !!(u_xlat26==1.0);
#else
    u_xlatb20 = u_xlat26==1.0;
#endif
    vs_TEXCOORD0.xy = (bool(u_xlatb20)) ? u_xlat4.xy : u_xlat19.xy;
#ifdef UNITY_ADRENO_ES3
    u_xlatb19 = !!(u_xlat0.y==1.0);
#else
    u_xlatb19 = u_xlat0.y==1.0;
#endif
    u_xlat7.x = u_xlatb19 ? 1.0 : float(0.0);
    ...
    u_xlat7.w = (-u_xlat26) + 1.0;
    vs_TEXCOORD1 = u_xlat7;
    u_xlat6.z = dot(in_TEXCOORD3.zw, vec2(65025.0, 255.0));
    vs_TEXCOORD2.xyz = u_xlat6.xyz;
    u_xlat10 = u_xlat0.w * u_xlat2.y;
    u_xlat10 = fract(u_xlat10);
    u_xlat26 = (-u_xlat2.x) * u_xlat10 + u_xlat0.w;
    u_xlat19.xy = in_TEXCOORD1.zw * vec2(8160.0, 2040.0);
    u_xlat4.y = u_xlat26 * 0.03125 + u_xlat19.y;
    u_xlat4.x = u_xlat2.x * u_xlat10 + u_xlat19.x;
    u_xlat2.xy = u_xlat4.xy + vec2(0.5, 0.5);
    u_xlat1.xy = u_xlat2.xy * _ShaderInfoTex_TexelSize.xy;
    vs_TEXCOORD3 = u_xlat1;
    u_xlat0 = textureLod(_ShaderInfoTex, u_xlat1.xy, 0.0);
    ...
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[2] * u_xlat18.xxxx + u_xlat0;
