...
void main()
{
    ...
    u_xlat18 = u_xlat16_22 * u_xlat16_22;
    u_xlat18 = u_xlat16_22 * u_xlat18;
    u_xlat18 = u_xlat16_22 * u_xlat18;
    u_xlat16_5.xyz = vec3(u_xlat18) * u_xlat16_5.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_18 = texture(_CameraGBufferTexture0, u_xlat1.xy).w;
    u_xlat1.x = (-u_xlat16_2.w) + 1.0;
    u_xlat16_5.xy = (-u_xlat1.xx) * vec2(0.699999988, 0.0799999982) + vec2(1.70000005, 0.600000024);
    u_xlat16_5.x = u_xlat1.x * u_xlat16_5.x;
    u_xlat16_5.x = u_xlat16_5.x * 6.0;
